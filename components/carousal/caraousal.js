            ...
            <Carousel.Item>
              ...
              <div className={styles.boxc12}>
                <p className={styles.boxCaption}>
                  Flexible Automation is a concept that allows a robotic cell to
                  be re-tasked quickly and easily allowing for multiple
                  automation processes while requiring minimal change over. The
                  main challenge has been dealing with parts that are difficult
                  to feed and those with high mix / low volume. Traditionally,
                  for many of these applications, automation has been cost
                  prohibitive. Investing in automation with Re-deployable Assets
                  now makes these applications feasible.
                </p>
              </div>
            </Carousel.Item>
            <Carousel.Item>
