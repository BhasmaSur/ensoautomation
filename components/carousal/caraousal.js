        ...
        <div>
            <div className={styles.box1}>
                <div className={styles.box1data1}>
                    <p className={styles.box1data1Content}>
                        Our Mission
                    </p>
                </div>
            ...
            <Carousel.Item>
                ...
                <div className={styles.boxc22}>
                    <p className={styles.boxCaption}>Reliable, easy-to-use still innovative solutions with responsive and expert services.
                    Your path to improved performance starts here.</p>
                </div>
            </Carousel.Item>
            <Carousel.Item>
                <img
